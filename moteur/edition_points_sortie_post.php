...
{ 
 ...
 $req = $bdd->prepare("SELECT SUM(id) FROM points_sortie WHERE nom = :nom ");//SELECT `titre_affectation` FROM affectations WHERE titre_affectation = "conssomables" LIMIT 1
