...
//martin vert
 ...
 $req = $bdd->prepare("SELECT SUM(id) FROM points_collecte WHERE nom = :nom AND id <> :id ");//SELECT `titre_affectation` FROM affectations WHERE titre_affectation = "conssomables" LIMIT 1
