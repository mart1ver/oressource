...
{
header("Location:../ifaces/edition_points_collecte.php?err=Un point de collecte porte deja le meme nom!&nom=".$_POST['nom']."&adresse=".$_POST['adresse']."&commentaire=".$_POST['commentaire']."&couleur=".substr($_POST['couleur'],1));
$req->closeCursor(); // Termine le traitement de la requête
}
...
// Insertion du post à l'aide d'une requête préparée
$req = $bdd->prepare('INSERT INTO points_collecte (nom, adresse, couleur, commentaire, visible) VALUES(?, ?, ?, ?, ?)');
