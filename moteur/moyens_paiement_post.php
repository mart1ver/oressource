<?php 
 ...
 $req = $bdd->prepare("SELECT SUM(id) FROM moyens_paiement WHERE nom = :nom ");//SELECT `titre_affectation` FROM affectations WHERE titre_affectation = "conssomables" LIMIT 1
