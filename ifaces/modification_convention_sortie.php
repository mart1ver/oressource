...
<?php
    if (isset($_SESSION['id']) AND (strpos($_SESSION['niveau'], 'g') !== false))
      { include "tete.php" ?>
    <div class="container">
        <h1>Gestions des partenaires de réemploi.</h1> 
         <div class="panel-heading">Modifier les données concernant lle partenaire n° <?php echo $_POST['id']?>, <?php echo $_POST['nom']?>.  </div>
<?php
