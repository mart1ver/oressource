...
<?php
    if (isset($_SESSION['id']) AND $_SESSION['systeme'] = "oressource" AND (strpos($_SESSION['niveau'], 'k') !== false))
      { include "tete.php" ?>
    <div class="container">
        <h1>Gestions des types de dechets sortants</h1> 
         <div class="panel-heading">Modifier les données concernant le type de dechet sortant n° <?php echo $_POST['id']?>, <?php echo $_POST['nom']?>. </div>
<?php
