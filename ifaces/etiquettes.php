...
<div class="panel-body">
  <fieldset>
    <legend>Étiquettes Boutique: à défricher </legend> 
  </fieldset>     
      ...
      <div class="panel panel-info">
        ...
        <div class="panel-heading">
          <label class="panel-title">Pesées pour statistiques:</label>
           <span class ="badge" id="recaptotal" style="float:right;">0 Kgs.</span>
           </div>
...
<ul id="boutons" class="list-group">
        <button class="btn btn-danger btn-lg" onclick="" style="height:70px">Imprimer</button>
