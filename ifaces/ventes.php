...
Somme due:
  <input type="text" class="form-control " placeholder="€" name="rendua" id="rendua" height="20" disabled>
...
Réglement
  <input type="text" class="form-control" placeholder="€" name="rendub" id="rendub" height="20" onfocus="fokus(this)" oninput="rendu()">
...
<b>A rendre</b>
  <input type="text" class="form-control" placeholder="€"  name="renduc" id="renduc" height="20" disabled>
