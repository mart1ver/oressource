...
$req = $bdd->prepare('SELECT pesees_sorties.id ,pesees_sorties.timestamp  ,type_dechets.nom,,type_dechets_evac.nom nom_evac  , pesees_sorties.masse ,type_dechets.couleur
                       FROM pesees_sorties ,type_dechets
                       WHERE type_dechets_evac.id = pesees_sorties.id_type_dechet_evac AND type_dechets.id = pesees_sorties.id_type_dechet AND pesees_sorties.id_sortie = :id_sortie
                       UNION 
                       SELECT pesees_sorties.id ,pesees_sorties.timestamp ,type_dechets.nom  ,type_dechets_evac.nom nom_evac , pesees_sorties.masse ,type_dechets_evac.couleur
